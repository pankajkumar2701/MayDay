...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MayDay", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<MayDayContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "MayDay API v1");
