...
using MayDay.Data;
using MayDay.Filter;
using MayDay.Entities;
using MayDay.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace MayDay.Controllers
{
    /// <summary>
    ...
    {
        private readonly MayDayContext _context;

        public RoleEntitlementController(MayDayContext context)
        {
            _context = context;
        }
